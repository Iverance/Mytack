<?PHP
    ...
    if(isset($_POST['submit'])){
        ...
        if($count != 0){
			...
			$sql = "INSERT INTO user (firstName, lastName, userBirthday, userName, email, userSecretQuest, userSecretAnswer, userPassword)
            ...
            //mysqli_query($con,"INSERT INTO user (firstName, lastName, userBday, userName, email, userSecretQuest, userSecretPass, userPassword)
            //            VALUES('{$firstName}', '{$lastName}', '{$userBday}', '{$userName}', '{$email}', '{$userSecretQuest}', '{$userSecretPass}', '{$userPassword}')");
